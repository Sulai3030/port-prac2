       ...
       <b-card class="card" style="width: 80rem;">
              ...
              <p class="text-center">
                <center>RELEVANT WORK EXPERIENCE</center>
                  <b-link href="https://partydash.com/" target="_blank">PartyDash App</b-link><p>PartyDash App
  ...
  <b-row>
     <b-col>
       <b-card class="card" style="width: 80rem;">
              ...
              <p class="text-center">
                <b-link href="https://www.mayapple.org/" target="_blank"><p>Mayapple Center for the Arts and Humanities</p></b-link>
              </p>
              <p>
                Webmaster                                                                                                                                                                         
              </p>
             ...
             <li>Input new faculty on Faculty page and Executive Board listing and names.</li> 
              <li>Communicated foundation’s message through updates on homepage about mission, events, enrollment opportunities and scholarships</li>
              <p></p>
              <hr />
        </b-card>
     </b-col>
  ...
  <b-row>
     <b-col>
       <b-card class="card" style="width: 80rem;">
              ...
              <p class="text-center">
                <b-link href="https://www.regeneron.com/" target="_blank">Regeneron, Inc. </b-link>
              </p>
                Technical Writer/ Content Management Writer/Editor,  Independent  Contractor 
              <p></p> 
              <p>Key Accomplishments </p>                                                                                                                                                                         	
              ...
              Removed departed Advisory Board members from Advisory Board page and added new Advisory Board Members
             <li>Input new faculty on Faculty page and Executive Board listing and names.</li> 
              <li>Utilized SME-obtained data to create FTP, Network, and IT Runbook from project start to project finish</li>
              <p></p>
              <hr />
       </b-card>
     </b-col>
  ...
  <b-row>
     <b-col>
       <b-card class="card" style="width: 80rem;">
              ...
              <p class="text-center">
                <b-link href="https://www.mayapple.org/" target="_blank"><p>Spruce Technology Inc.                                                                                                                                                                       </p></b-link>
              </p>
              <p>
                Technical Writer,  Independent  Contractor                                                                                                                                                                         
              </p>
              <p>
                Wrote and edited complex technical information to present in a clear concise way as User Guides and Manuals to aid end-users such as architects, contractors, superintendents and the general public in understanding and using the online portal for the New York City’s Department of Buildings’ website (Microsoft Dynamics CRM platform). Transformed pre-existing design specifications, project plans, text plans, research and business correspondence into online templates for general public access.
              </p>
              Key Accomplishments:
              <li>Converted thousands of pre-existing paper documents from the Department of Building’s inception in 1936 into easily-accessible and understandable online information that is easily accessed and used by the general public</li>
              <li>
  ...
  <b-row>
     <b-col>
       <b-card class="card" style="width: 80rem;">
              ...
              <p class="text-center">
                <b-link href="https://nymedicaidchoice.com/" target="_blank"><p>Maximus Inc.                                                                                                                                                                       </p></b-link>
              </p>
              <p>
                Assistant Editor/Website QA,  Independent  Contractor                                                                                                                                                                       
              </p>
              <p>
              ...
              Key Accomplishments:
              <li>Project managed professional recording sessions with Native speakers of multiple languages (6) of new plan material so hearing and developmentally-impaired citizens of New York State could access these plan changes in ADA-compliant ways</li>
              <li>
                ...
                <li>Translated communications from legal team in Albany about new health care coverage and requirements from legalese into clear concise and easily understandable materials that was distributed to the general public</li>
